...
public class CouponServiceTest {
    ...
    void issueCoupon() {
        ...
        given(couponRepository.findByIdForUpdate(any(Long.class))).willReturn(Optional.of(coupon));
        ...
        verify(couponRepository).findByIdForUpdate(anyLong());
    ...
    void issueNotExistingCouponThrowsException() {
        ...
        given(couponRepository.findByIdForUpdate(any(Long.class))).willReturn(Optional.empty());
